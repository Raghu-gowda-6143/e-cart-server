const products = [
    ...
    {
        id: '8',
        url: 'https://m.media-amazon.com/images/I/71fJ-gmBZtL._SX679_.jpg',
        detailUrl: 'https://rukminim1.flixcart.com/image/416/416/kg8avm80/mobile/g/n/w/apple-iphone-12-pro-max-dummyapplefsn-original-imafwgcyauknkgwh.jpeg?q=70',
        title: {
            shortTitle: 'iPhone 12 Pro Max',
            longTitle: 'APPLE iPhone 12 Pro Max (Gold, 256 GB) '
        },
        price: {
            mrp: 139900,
            cost: 135900,
        ...
        quantity: 1,
        description: `6.7-inch (17 cm diagonal) Super Retina XDR display
    ...
    {
        id: '9',
        url: 'https://m.media-amazon.com/images/I/71tpxtLD0aL._SL1500_.jpg',
        detailUrl: 'https://rukminim1.flixcart.com/image/416/416/k2jbyq80pkrrdj/mobile-refurbished/y/k/z/iphone-11-64-a-mwlx2hn-a-apple-0-original-imafkg24ymsjav9h.jpeg?q=70',
        title: {
            shortTitle: 'iPhone 11',
            longTitle: 'APPLE iPhone 11 (Purple, 64 GB) '
        },
        price: {
            mrp: 54900,
            cost: 51999,
    ...
    {
        id: '10',
        url: 'https://m.media-amazon.com/images/I/51-jsOapfDS._UL1000_.jpg',
        detailUrl: 'https://rukminim1.flixcart.com/image/800/960/kp1imq80/shoe/g/x/o/11-cw3419-003nike-nike-black-university-red-lt-smoke-grey-white-original-imag3d6ch4rhausr.jpeg?q=50',
        title: {
            shortTitle: 'Nike shoes for men',
            longTitle: `NIKE 
            Winflo 8 Running Shoes For Men  (Black) `
        },
        price: {
            mrp: 8295,
            cost: 6553,
        ...
        quantity: 1,
        description: `When running is an everyday habit, you need support to match your speed. The Nike Winflo 8 brings back the cushioning you love and pairs it with details like a translucent upper and Flywire technology for a snug, stable fit for long runs`,
        category: 'fashion'
    }
];
